...
\begin{itemize}
\item {\fontspec{sourcecodepro} {''}config{''}} This will send configuration parameters to the plotter and fitter, such as axis labels, plot label, legend labels, as well as what kind of function to plot, what are the plot starting parameters, plot limits, etc.
\item {\fontspec{sourcecodepro} {''}data{''}} This send data point by point to the plotter. Once the plotter receives each data point, it immediately puts it on the screen
\item {\fontspec{sourcecodepro} {''}fitrequest{''}} This tells the plotter which fit to send back to the client. 
\end{itemize}
